...
<div class="jumbotron text-center">
  <h1>GAMES</h1>
  <p>Game phù hợp cho những người trên 18 tuổi.</p> 
</div>
...
<div class="container">
  ...
  ?>
    <div class="col-lg-4 col-sm-6 item" style="border-style: outset;">
      <img class="img-responsive" style="height:200px;" src="<?php echo $row['img'] ?>">
